...
<body onload="actualizarTamanoLista('listado'); mensajeLicencia();" onresize="actualizarTamanoLista('listado');"	>
	...
	<table width="100%">
	  <tr> 
	    <td width="25%"><input type="button" name="btnNuevaLicencia" id="btn100" value="AGREGAR LICENCIA" onClick="fichaLicenciaMedica.className='fichaActiva'" <? if(!$permisoRegistrar) echo "disabled";?>></td>
	  	<td width="20%" >&nbsp;</td>
