		...
		if(objHttpXMLLicencias.readyState == 4){
			...
			if (objHttpXMLLicencias.responseText != "VACIO"){
				...
				for(i=0;i<xml.getElementsByTagName('licencia').length;i++){
					...
					LinkArchivo	 = (Color=='IM') ? '<a href="./archivos_licencia/'+Archivo+'" target="_blank"> <img src="img/carpeta.png" width=15 height=15 > </a>' : '<img src="img/carpeta.png" width=15 height=15 alt="Licencia IMED" >';
